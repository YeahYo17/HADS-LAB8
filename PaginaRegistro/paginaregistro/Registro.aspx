...
<body>
    ...
    <div>
        ...
        <br />
        <br />
        <asp:Panel ID="Panel1" runat="server" style="z-index: 1; left: 90px; top: 113px; position: absolute; height: 884px; width: 585px">
            Email:<br />
            ...
            &nbsp;&nbsp;&nbsp;
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtDni" ErrorMessage="El formato del DNI es incorrecto" style="color: #FF0000; z-index: 1; left: 194px; top: 247px; position: absolute;" ValidationExpression="\d{8}[a-zA-Z]">* El DNI introducido es incorrecto</asp:RegularExpressionValidator>
            <br />
            <br />
            Password:<br />
            ...
            &nbsp;&nbsp;&nbsp;
            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtPassReg" ControlToValidate="txtRepPass" ErrorMessage="La Repeticion del Password es incorrecta" style="color: #FF0000; z-index: 1; left: 194px; top: 360px; position: absolute;">* No coincide con el Password introducido</asp:CompareValidator>
            <br />
            <br />
            Pregunta Secreta:<br />
