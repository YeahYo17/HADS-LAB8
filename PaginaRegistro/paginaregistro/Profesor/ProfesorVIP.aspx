<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Vadillo.aspx.vb" Inherits="PaginaRegistro.Profesor" %>
...
<body style="height: 754px; width: 1350px;">
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="Panel1" runat="server" style="text-align: center; background-color: #3366CC; z-index: 1; left: 21px; top: 34px; position: absolute; height: 500px; width: 178px;" Width="170px" BorderStyle="Inset">
            ...
            <br />
            <strong>
            <asp:HyperLink ID="hlImpDS0" runat="server" NavigateUrl="~/Profesor/Coordinador.aspx" style="text-align: left; color: #FFFFFF;">Horas Dedicacion Media</asp:HyperLink>
            </strong>
            <br />
            <br />
            </strong>
