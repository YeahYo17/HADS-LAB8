<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="NewRegistro.aspx.vb" Inherits="PaginaRegistro.NewRegistro" %>
...
<body>
    ...
    <div style="height: 985px">
        ...
        <br />
        <br />
        <asp:Panel ID="Panel1" runat="server" style="z-index: 1; left: 90px; top: 112px; position: absolute; height: 850px; width: 585px">
            Email:<br />
            ...
            &nbsp;&nbsp;&nbsp;
            <asp:RegularExpressionValidator ID="validacionEmail" runat="server" ErrorMessage="Formato de email incorrecto" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" style="position: absolute; color: #FF0000; z-index: 1; left: 194px; top: 16px; height: 18px;" ControlToValidate="txtEmailReg">* Formato de email incorrecto</asp:RegularExpressionValidator>
            <br />
            <br />
            Nombre:<br />
            ...
            &nbsp;&nbsp;&nbsp;
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtDni" ErrorMessage="El formato del DNI es incorrecto" style="color: #FF0000; z-index: 1; left: 194px; top: 132px; position: absolute;" ValidationExpression="\d{8}">* El DNI introducido es incorrecto</asp:RegularExpressionValidator>
            <br />
            <br />
            Password:<br />
            ...
            &nbsp;&nbsp;&nbsp;
            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtPassReg" ControlToValidate="txtRepPass" ErrorMessage="La Repeticion del Password es incorrecta" style="color: #FF0000; z-index: 1; left: 194px; top: 247px; position: absolute;">* No coincide con el Password introducido</asp:CompareValidator>
            <br />
            <br />
            Pregunta Secreta:<br />
            ...
            &nbsp;&nbsp;&nbsp;
            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="txtRespuesta" ErrorMessage="No se ha introducido Respuesta Secreta" style="color: #FF0000">* Campo Obligatorio</asp:RequiredFieldValidator>
            <br />
            <br />
            <asp:RadioButtonList ID="rdbTipo" runat="server" RepeatDirection="Horizontal" Width="200px">
